 ...
 */
export const splitRows = (length = 1) => (source: Observable<string>) => source.pipe(
 ...
 */
export const matchMap = <T>(regex: RegExp, mapFn: (match: RegExpMatchArray) => T) => (source: Observable<string>) => source.pipe(

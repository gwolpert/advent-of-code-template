import {type Observable, first, tap} from 'rxjs';
import {Solution, ExecutionInfo} from "@types";
 ...
 */
export const executeSolution = (solution: Solution, {day, part}: ExecutionInfo, start = performance.now()) =>
